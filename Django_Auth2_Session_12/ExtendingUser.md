...
3. Adding New Fields to Default User by Using AbstractUser (ikinci bir tablo olusturma degilde ikinci tablodaki alanlari birinci tabloya ekleme) burada sadece ikinci olarak tek bir tablo eklemek zorunda degiliz. mesela sehir diye bir tabloda yapilabilir. olusturdugumuz her bir tablo da user tablosundan user lara ait bir id bulunur. 
4. Redefining Default User from Scratch by Using AbstractBaseUser (kendimize güveniyorsak iki tabloyu da elimizle yazariz.)
