...
api genel isim. rest api ise http protokol ise api leri tasarlama mimarisi. 

api json formatinda bir dosya bir yazilim denebilir. 

What is REST API?
asagida bulunan 6 özellik saglandiginda restFul api denir. 
...
Django ile db arasindaki islemler orm vasitasi ile yürütülür. 

Db den orm ile gelen ve python object leri tipinde olan verileri json formatina ceviren yapi serializers. Tersinden de json verileri python object lerine ceviren yapi, yine serializers.  

serializers yapisini kullanacak yapi da django rest framework dur. 
...
Model -> Form : Modeli baz alarak HTML/Form ile etkileşim.
Model -> Serializers : Modeli baz alarak API/Json ile etkileşim.
...
tüm bu kodlar yazildiktan sonra karsimiza cikan api seklindeki django arayüzüne browsable api denir. 

Dikkat: template ile ugrasmiyoruz. django hazir template i kullandik. 

Browsable api bize post imkani da verir. Cünkü view imizda post da yazdik.

patch de partial düzeltme yapılıyor. put toptan değiştiriyor
yani update yaparken put da degistirmek istemesek de tüm alanlari girmek zorundayiz. patch de ise sadece degistirmek istedigimiz alanlari girmemiz yeterli. 

Browsable api bize patch imkani put imkani da sunar. view de bu kodlar var. 

delete imkani da sunar

hepsini deneyelim. delete icin url de id girmemiz gerekir. 
...
## Relational fields
Ben buradan asagisini kacirdim.

tablolar arasindaki bütün iliski id ve foreign keyler üzerinen yürür. path secimleri tarzinda seylerde isim gecmez. path i n id nosu ile path secimi yapilir. 

stringrelated field:  models de str icinde yazili alanlari getirir sadece. 
