...
```python
import os
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') ## bu eskiden kullaniliyordu
  ## simdi ise bu ikisi kullanilir. bunlar settings.py da static altina kopyalanir
...
## eger bu kodu eklemezsek yükledigimiz fotolari göremeyiz
